...
public:
	...
	// 인장 조회
	UFUNCTION(BlueprintPure, Category = "Profile|Economy")
	int32 GetSeal() const;

	UFUNCTION(BlueprintPure, Category = "Profile|Economy")
	bool CanSpendSeal(int32 Amount) const;

	// 인장 획득
	UFUNCTION(BlueprintCallable, Category = "Profile|Economy")
	bool AddSeal(int32 Amount);

	// 인장 소비
	UFUNCTION(BlueprintCallable, Category = "Profile|Economy")
	bool TrySpendSeal(int32 Amount);

	UPROPERTY(BlueprintAssignable, Category = "Profile|Economy")
	FOnSealChanged OnSealChanged;
